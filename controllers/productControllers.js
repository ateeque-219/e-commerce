...
const getProductController=async(req,res)=>{
  const product = await Product.find({}).select("-photo").limit(12).sort({createdat:-1}).populate("category");
  res.status(200).send({
    success:true,
...
export { CreateProductController , getProductController ,deleteProductController, getSingleProductController,productPhotoController};
